...
const i18n = {
  en: {
    ...
    tour:{ skip:'Skip tour', next:'Next', done:'Done ✓',
      steps:[
  ...
  km: {
    ...
    tour:{ skip:'រំលង', next:'បន្ទាប់', done:'រួចរាល់ ✓',
      steps:[
...
export default function App() {
  ...
  return (
    <div style={{ minHeight:'100vh', background:c.bgBase, color:c.text1, fontFamily:tf, display:'flex', flexDirection:'column', transition:'background 0.2s, color 0.2s', overflowX:'hidden', width:'100%' }}>
      ...
      {/* ── Main grid ── */}
      <main style={{ width:'100%', maxWidth:'100vw', overflowX:'hidden', padding:isMobile?'0.75rem 0.75rem 2rem':'1.25rem 1.25rem 2rem', display:'grid', gridTemplateColumns:isMobile||isTablet?'minmax(0,1fr)':'minmax(0,1fr) minmax(0,1fr)', gap:'1rem', flex:1 }}>
